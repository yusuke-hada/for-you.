...
Rails.application.config.sorcery.configure do |config|
  ...
  config.line.key = Rails.application.credentials.line_login[:LINE_CHANNEL_ID]
  config.line.secret = Rails.application.credentials.line_login[:LINE_CHANNEL_SECRET]
